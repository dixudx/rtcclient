...
pa1 = (
    xmltodict.parse(read_fixture("projectareas.xml"))
...
ta1 = (
    xmltodict.parse(read_fixture("teamareas.xml"))
    .get("oslc_cm:Collection")
    .get("rtc_cm:Team")[0]
)
...
plannedfor1 = (
    xmltodict.parse(read_fixture("plannedfors.xml"))
    .get("oslc_cm:Collection")
...
severity1 = (
    xmltodict.parse(read_fixture("severities.xml"))
    .get("oslc_cm:Collection")
...
priority1 = (
    xmltodict.parse(read_fixture("priorities.xml"))
    .get("oslc_cm:Collection")
    .get("rtc_cm:Literal")[0]
)
...
foundin1 = (
    xmltodict.parse(read_fixture("foundins.xml"))
    .get("oslc_cm:Collection")
...
filedagainst1 = (
    xmltodict.parse(read_fixture("filedagainsts.xml"))
    .get("oslc_cm:Collection")
...
workitem1 = (
    xmltodict.parse(read_fixture("workitems.xml"))
    .get("oslc_cm:Collection")
...
member1 = (
    xmltodict.parse(read_fixture("members.xml"))
    .get("oslc_cm:Collection")
    .get("rtc_cm:User")[0]
)
...
itemtype1 = (
    xmltodict.parse(read_fixture("itemtypes.xml"))
    .get("oslc_cm:Collection")
    .get("rtc_cm:Type")[0]
)
...
admin = (
    xmltodict.parse(read_fixture("administrators.xml"))
    .get("oslc_cm:Collection")
    .get("rtc_cm:User")
)

comment1 = (
    xmltodict.parse(read_fixture("comments.xml"))
    .get("oslc_cm:Collection")
...
action1 = (
    xmltodict.parse(read_fixture("actions.xml"))
    .get("oslc_cm:Collection")
    .get("rtc_cm:Action")[0]
)
...
role1 = xmltodict.parse(read_fixture("roles.xml")).get("jp06:roles").get("jp06:role")[0]

role2 = xmltodict.parse(read_fixture("roles.xml")).get("jp06:roles").get("jp06:role")[1]

role3 = xmltodict.parse(read_fixture("roles.xml")).get("jp06:roles").get("jp06:role")[2]

state1 = (
    xmltodict.parse(read_fixture("states.xml"))
    .get("oslc_cm:Collection")
    .get("rtc_cm:Status")[0]
)
...
savedquery1 = (
    xmltodict.parse(read_fixture("savedqueries.xml"))
    .get("oslc_cm:Collection")
    .get("rtc_cm:Query")[0]
)
...
includedinbuild1 = (
    xmltodict.parse(read_fixture("includedinbuilds.xml"))
    .get("oslc_cm:Collection")
...
children1 = (
    xmltodict.parse(read_fixture("children.xml"))
    .get("oslc_cm:Collection")
    .get("oslc_cm:ChangeRequest")[0]
)
...
parent = (
    xmltodict.parse(read_fixture("parent.xml"))
    .get("oslc_cm:Collection")
    .get("oslc_cm:ChangeRequest")
)

changeset1 = (
    xmltodict.parse(read_fixture("changesets.xml"))
    .get("oslc_cm:Collection")
...
attachment1 = (
    xmltodict.parse(read_fixture("attachment.xml"))
    .get("oslc_cm:Collection")
